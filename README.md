...
## Future improvements:
*  Expanding the maximum length of inputs so you can enter a to-do input which can be as long as you need it to be
*  Adjusting the view to fit user requirements
